...
- Three kinds of file. A flow in `public/specs/flows/` is the source of truth for a feature. A doc in `public/specs/docs/` describes something that is not a feature, a setup, an environment, a shared reference. A ref in `public/specs/refs/` is a strategy that was evaluated and not taken, kept for comparison and never built.
...
### Flow File Structure
- Location: `public/specs/flows/<area>/<Feature>.md`. A provider takes its own level when the flow is provider specific, `public/specs/flows/<area>/<provider>/<Feature>.md`.
...
## Docs
- Location: `public/specs/docs/<area>/<Topic>.md`, PascalCase file names and lowercase directories, same as a flow.
  - `public/specs/docs/conventions/` holds the files that define how this repo works, `Terms.md` and `Status.md`. `public/specs/docs/setup/` holds the files that describe a system.
...
- Header lines at top of every doc:
  - `Status: wip | done`, defined in [public/specs/docs/conventions/Status.md](public/specs/docs/conventions/Status.md)
  - `Updated: YYYY-MM-DD`
...
- Header lines at top of every ref:
  - `Status: wip | ref`, defined in [public/specs/docs/conventions/Status.md](public/specs/docs/conventions/Status.md)
  - `Updated: YYYY-MM-DD`
