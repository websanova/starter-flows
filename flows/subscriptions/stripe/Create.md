...
- Refuse anyone who already has a Stripe Subscription. Past due and unpaid refuse with their own error so the App can send the User to the [Payment Method update](../../billing/stripe/PaymentMethodUpdate.md) page.
