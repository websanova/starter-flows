...
- Bump the `Updated:` header on any file touched, then match the date in the README table and `public/files.json`. A new file or a status change needs a row in both.
